...
common::types::MappingBounds parseBounds(const YAML::Node& boundaries,
...
common::types::DroneConfigData ConfigParser::parseDroneConfig(const std::filesystem::path& filepath) {
    try {
...
common::types::MissionConfigData ConfigParser::parseMissionConfig(const std::filesystem::path& filepath) {
    try {
        const YAML::Node root = loadRoot(filepath);
        const YAML::Node config =
        ...
        return common::types::MissionConfigData{
...
common::types::LidarConfigData ConfigParser::parseLidarConfig(const std::filesystem::path& filepath) {
    try {
        const YAML::Node root = loadRoot(filepath);
        const YAML::Node config =
        ...
        return common::types::LidarConfigData{
...
common::types::SimulationConfigData
ConfigParser::parseSimulationConfig(const std::filesystem::path& filepath) {
    try {
        ...
        return common::types::SimulationConfigData{
            map_filename,
...
common::types::SimulationCompositionData
ConfigParser::parseSimulationComposition(const std::filesystem::path& filepath) {
    try {
        ...
        std::vector<std::tuple<common::types::SimulationConfigData, std::vector<common::types::MissionConfigData>>>
        ...
        for (const YAML::Node& simulation_entry : simulations) {
            const std::filesystem::path simulation_file = resolvePath(
                ...
                composition_dir);
            common::types::SimulationConfigData simulation =
        ...
        return common::types::SimulationCompositionData{
            composition_file,
