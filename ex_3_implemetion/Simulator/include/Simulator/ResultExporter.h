 ...
 * @brief Result for one single simulation combination run.
 */
struct SingleRunResult {
...
public:
    ...
    /**
     * @brief Exports detailed per-SO individual runs report YAML file.
     */
    ...
    /**
     * @brief Exports collected error logs to an error_log.txt file.
     */
    static void exportErrorLog(
        const std::filesystem::path& output_dir,
