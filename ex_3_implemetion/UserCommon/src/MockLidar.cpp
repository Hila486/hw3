...
/// Returns beam count for a FOV circle index (1, 4, 16, 64, etc.).
...
/// Calculates horizontal angular offset.
...
/// Calculates altitude angular offset.
...
MockLidar::MockLidar(common::types::LidarConfigData config, const common::IMap3D& map, const common::IGPS& gps)
...
/**
 * @brief Simulates a multi-beam LiDAR scan from current drone position & heading.
 */
...
/**
 * @brief Ray-casts a single laser beam into the ground-truth map to locate obstacles.
 */
